    ...
    else
    {
        if(list_str->cur_num_of_nodes != 0)
        {
            if(list_realloc(list_str) == 1)
            {
                ...
                list_str->nodes_arr[list_str->cur_num_of_nodes].next = list_str->nodes_arr[node_index].next;
                list_str->nodes_arr[list_str->cur_num_of_nodes].prev = node_index;
                list_str->nodes_arr[list_str->nodes_arr[node_index].next].prev = list_str->cur_num_of_nodes;
...
void delete_node(list* list_str, size_t node_index)
{
...
{
    list_str->cur_num_of_nodes = 0;
    list_str->max_num_of_nodes = 5;
